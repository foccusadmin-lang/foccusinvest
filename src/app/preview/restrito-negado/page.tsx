...
export default function PreviewRestritoNegadoPage() {
  return (
    <div className="flex min-h-screen flex-1 flex-col items-center justify-center bg-background px-4">
      <div className="w-full max-w-md rounded-2xl border border-red-900/40 bg-surface p-8 text-center">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted">
          Tentativas de acesso não autorizado poderão ser registradas e submetidas às medidas de
          segurança previstas nos Termos de Uso.
        </p>
        <div className="mt-8">
          <LinkButton href="/preview/login" variant="outline" className="w-full">
            Entrar como administrador
          </LinkButton>
        </div>
        <Link href="/" className="mt-6 inline-block text-xs text-muted hover:text-gold-light">
          Voltar ao início
        </Link>
      </div>
    </div>
