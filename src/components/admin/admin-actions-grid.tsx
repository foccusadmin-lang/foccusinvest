...
const BOTOES: Botao[] = [
  ...
  },
  {
    ...
    href: "/restrito/fundo-caixa",
    cor: "bg-lime-600 hover:bg-lime-500",
    icone: <IconGeneric path="M20 12V8H4v12h16v-4M20 12a2 2 0 0 0 0-4M4 8l2-4h12l2 4" />,
  },
  {
  ...
  {
    label: "Liderança",
    href: "/restrito/lideranca",
    cor: "bg-amber-700 hover:bg-amber-600",
    icone: <IconGeneric path="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />,
  },
  {
