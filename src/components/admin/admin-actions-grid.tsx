...
const BOTOES: Botao[] = [
  ...
  { label: "Ativar Saldo", cor: "bg-emerald-600", icone: <IconGeneric path="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />, emBreve: true },
  { label: "Gestão de Indicação", cor: "bg-fuchsia-600", icone: <IconGeneric path="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM19 8v6M22 11h-6" />, emBreve: true },
  { label: "Gestão de Códigos", cor: "bg-indigo-600", icone: <IconGeneric path="M10 13a5 5 0 0 0 7 0l3-3a5 5 0 0 0-7-7l-1 1M14 11a5 5 0 0 0-7 0l-3 3a5 5 0 0 0 7 7l1-1" />, emBreve: true },
  { label: "Criar por e-mail", cor: "bg-orange-600", icone: <IconGeneric path="M4 4h16v16H4zM22 6l-10 7L2 6" />, emBreve: true },
  ...
  { label: "Gráficos e Análises", cor: "bg-blue-600", icone: <IconGeneric path="M3 3v18h18M18 17V9M13 17V5M8 17v-4" />, emBreve: true },
  { label: "Configurações do Sistema", cor: "bg-rose-700", icone: <IconGeneric path="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM19.4 15a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1 1.55V21a2 2 0 0 1-4 0v-.09a1.7 1.7 0 0 0-1-1.55 1.7 1.7 0 0 0-1.87.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.7 1.7 0 0 0 .34-1.87 1.7 1.7 0 0 0-1.55-1H3a2 2 0 0 1 0-4h.09a1.7 1.7 0 0 0 1.55-1 1.7 1.7 0 0 0-.34-1.87l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.7 1.7 0 0 0 1.87.34H9a1.7 1.7 0 0 0 1-1.55V3a2 2 0 0 1 4 0v.09a1.7 1.7 0 0 0 1 1.55 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.34 1.87V9a1.7 1.7 0 0 0 1.55 1H21a2 2 0 0 1 0 4h-.09a1.7 1.7 0 0 0-1.55 1Z" />, emBreve: true },
];
